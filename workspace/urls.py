...
from . import views
from workspace.views import get_commit_history, rollback_commit_view, get_branch_files
...
urlpatterns = [
    ...
    path('git-rollback/', rollback_commit_view, name='git_rollback'), # rollback 기능
    path('git-branch-files/', get_branch_files, name='git_branch_files'), # branch 조회 기능
]
